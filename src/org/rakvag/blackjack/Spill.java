...
public class Spill {
    ...
    private boolean erSpilletFullfoert() {
        boolean spillerHarBlackJack = spiller.harBlackJack();
        boolean spillerErBust = spiller.erBust();
        boolean dealerErBust = dealer.erBust();
        return spillerHarBlackJack || spillerErBust || dealerErBust || (spiller.staar() && !dealer.kanTrekkeNyttKort());
    }
